...
export default [
    {
        languageOptions: {
            globals: {
                ...
                VIEW_H: "readonly",
                Peer: "readonly",
                MultiplayerSystem: "readonly",
                TILE_SIZE: "readonly",
                StoreSystem: "readonly",
                ArenaSystem: "readonly",
                DefenseSystem: "readonly",
                LiminalSystem: "readonly",
                EnemySystem: "readonly",
                CraftingSystem: "readonly",
                MapSystem: "readonly",
                RPGSystem: "readonly",
                GuardianSystem: "readonly",
                ResourceSystem: "readonly",
                BountySystem: "readonly",
                DungeonSystem: "readonly",
                Renderer: "readonly",
                Player: "readonly",
                World: "readonly",
                GameClock: "readonly",
                CombineSystem: "readonly",
                RivalSystem: "readonly",
                HomeSystem: "readonly",
                handleNPCInteraction: "readonly",
                handlePokeCenterInteraction: "readonly"
            }
        },
        rules: {
            "no-unused-vars": "off",
